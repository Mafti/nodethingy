...
/*===========================================================================================================================================================================*/
/*    here we create a server that listens on port 80 and returns a hello world. This is A BAD PATTERN and NEEDS TO BE DELETED after the tests with kubernetes have finished */
/*===========================================================================================================================================================================*/
/*
http.createServer(
	function (req, res) {
		// create default result
		var result = {};
		result.code = 200; // Page not found
		...
		try {
			// A call is received on the webservice
			system_notify_message("HTTP Received request ON A BAD PATTERN: " + req.url, STATUS_TYPE.HTTP_SERVER_INCOMING);
			system_notify_message("- User agent            " + req.headers["user-agent"], STATUS_TYPE.HTTP_SERVER_INCOMING);
			system_notify_message("- Remote address/port   " + req.socket.remoteAddress + ":" + req.socket.remotePort, STATUS_TYPE.HTTP_SERVER_INCOMING);
			system_notify_message("- Local address/port    " + req.socket.localAddress + ":" + req.socket.localPort, STATUS_TYPE.HTTP_SERVER_INCOMING);			
		} catch (ex_message) {
...
system_notify_message("HTTP server is listening on port " + port80 + "....", STATUS_TYPE.HTTP_SERVER);
*/

/*===========================================================================================================================================================================*/
/*   above we create a server that listens on port 80 and returns a hello world. This is A BAD PATTERN and NEEDS TO BE DELETED after the tests with kubernetes have finished */
/*===========================================================================================================================================================================*/
